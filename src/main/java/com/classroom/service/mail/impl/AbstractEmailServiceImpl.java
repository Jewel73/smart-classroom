...
import com.classroom.constant.user.PasswordConstants;
...
import com.classroom.util.core.WebUtils;
import com.classroom.web.payload.request.mail.FeedbackRequest;
  ...
  public void sendAccountVerificationEmail(UserDto userDto, String token) {
    ...
    var emailRequest =
        prepareHtmlEmailRequest(
            userDto,
            token,
            AdminConstants.API_V1_USERS_ROOT_URL + SignUpConstants.SIGN_UP_VERIFY_MAPPING,
