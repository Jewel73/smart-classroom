package com.classroom.dto.mapper;
...
public interface UserHistoryDtoMapper {
  ...
  @Mapping(
      ...
      expression =
          "java(com.classroom.util.core.DateUtils.getTimeElapsedDescription(userHistory.getCreatedAt()))")
  @Mapping(
      target = "separateDateFormat",
      expression =
          "java(com.classroom.util.core.DateUtils.getTimeElapsed(userHistory.getCreatedAt()))")
